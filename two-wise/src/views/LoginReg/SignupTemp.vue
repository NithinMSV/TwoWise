    ...
    <div class="signup-client">
        <form class="needs-validation" novalidate>
            <div class="row">
                ...
                <input type="text" class="form-control" id="InputFirstName" aria-describedby="name" placeholder="First Name">
                </div>
                </div>
                <div class="col">
                <div class="form-group">
                <label for="InputLastName">Last Name</label>
                <input type="text" class="form-control" id="InputLastName" aria-describedby="name" placeholder="Last Name">
                </div>
                </div>
            </div>
            <div class="row">
                ...
                <input type="email" class="form-control" id="InputEmail1" aria-describedby="emailHelp" placeholder="Email Address">
                </div>
                </div>
                <div class="col">
                <div class="form-group">
                <label for="InputClientID">Client ID</label>
                <input type="text" class="form-control" id="InputClientID" aria-describedby="emailHelp" placeholder="Client ID">
                </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <input type="text" class="form-control" id="InputFirstName" aria-describedby="name" placeholder="Business Name">
                </div>
                </div>
                <div class="col">
                <div class="form-group">
            ...
            <div class="row">
                ...
                <br />
                <select id="industry-select" class="option-select">
                <option v-for="country in optionsforcountries" :key="country">
                    {{country.name}}
                </option>
                </select>
                </div>
            ...
            <div class="row">
                ...
                <b-form-datepicker id="example-datepicker" v-model="dobvalue" class="mb-2" placeholder="Select your Date of Birth"></b-form-datepicker>
                </div>
                </div>
                <div class="col">
                <div class="form-group">
                <label for="InputMobileNumber">Mobile Number</label>
                <input type="text" pattern="^[0-9]*$" class="form-control" id="InputMobileNumber" aria-describedby="name" placeholder="Mobile Number">
                </div>
                </div>
            </div>
            <div class="row">
                ...
                <br />
                <select id="gender-select" class="option-select">
